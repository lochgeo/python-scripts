...
def check_repo(repo_path, github_repo):
    checks = {
        ...
        "README.md lines added > 10 in last edit": check_readme_lines_added(
            github_repo),
        ...
        "Demo video/presentation exists": check_demo_video_or_presentation(
            repo_path),
...
def main():
    ...
    with open(csv_filename, 'w', newline='') as csvfile:
        ...
        for repo in org.get_repos():
            # Add this condition to process only repos starting with "gaipl"
            if repo.name.startswith("gaipl"):
                ...
                print(
                    f"Skipping repository: {repo.full_name} as it does not start with 'gaipl'")
